...
class ConstellationDetailScreen extends StatefulWidget {
  const ConstellationDetailScreen({super.key});
...
class _ConstellationDetailScreenState extends State<ConstellationDetailScreen> {
  ...
  void initState() {
    super.initState();
    final bloc = context.read<ConstellationBloc>();
    bloc.add(FetchConstellationZodiac());
                            ...
                            Expanded(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 20),
                                  Visibility(
                                    visible: zodiac.data.bestTraits.isNotEmpty,
                                    child: Text(
                                  ...
                                  SizedBox(height: 20),
                                  Visibility(
                                    visible: zodiac.data.symbolized.isNotEmpty,
                                    child: Text(
